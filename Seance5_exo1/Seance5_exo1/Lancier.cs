...
namespace Seance5_exo1
{
    ...
    class Lancier : Personnage
    {
        Random bonus = new Random();

       private string poste;
       private int degat_personnage = 3;

        public Lancier(string nom, int Point_de_vie) : base(nom, Point_de_vie)
        {
            this.Nom = nom;
            this.Point_de_vie1 = Point_de_vie;
            this.PvMax = Point_de_vie;
            this.Degat = this.Degat + degat_personnage;
            Console.Write("Quel est le poste de " + nom + " ? : ");
            this.poste = Console.ReadLine();
        }

        public int bonus_lance()
        {
            int r;
