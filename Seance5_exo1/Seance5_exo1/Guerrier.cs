...
namespace Seance5_exo1
{
    class Guerrier : Personnage
    {
       ...
       private int rage;
       private int rageMax;
       private int degat_personnage = 5;
        
        public Guerrier(string nom, int Point_de_vie) : base(nom, Point_de_vie)
        {
            this.Nom = nom;
            this.Point_de_vie1 = Point_de_vie;
            this.PvMax = Point_de_vie;
            this.rageMax = 10;
            this.Degat = this.Degat + degat_personnage;
            Console.Write("Quel est le nom de clan de " + nom +" ? : ");
            this.clan = Console.ReadLine();

        }

        public void Rageup()
        {
            if( Point_de_vie1 < (PvMax/2))
            {
                if(rage < rageMax)
